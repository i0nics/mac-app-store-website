...
function submit_form() {
	...
	if (isError) {
		...
		alert('Welcome ' + $('#first_name').val() + '! Sign in to continue.');
...
function sign_in() {
	...
	$('#submit_login').click(function () {
		if(localStorage.getItem('email') == $('#in_email').val() && localStorage.getItem('password') == $('#in_pass').val()) {
			setCookie('logged', 'yes')
			alert('Welcome to the Mac App Store!');
